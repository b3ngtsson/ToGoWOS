...
public class DepartureBoardApi {
    ...
    public DepartureBoardApi() {
        this(Configuration.getDefaultApiClient());
    }

    public DepartureBoardApi(ApiClient apiClient) {
    ...
    /**
     * Build call for getDepartureBoard
     ...
     * @param direction stop id in order to get only departures of vehicles with a specified direction (optional)
     ...
     */
    public com.squareup.okhttp.Call getDepartureBoardCall(Long id, LocalDate date, String time, String useVas, String useLDTrain, String useRegTrain, String useBus, String useBoat, String useTram, String excludeDR, Integer timeSpan, Integer maxDeparturesPerLine, String needJourneyDetail, Long direction, String format, String jsonpCallback, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;

        // create path and map variables
        String localVarPath = "/departureBoard";
    ...
    private com.squareup.okhttp.Call getDepartureBoardValidateBeforeCall(Long id, LocalDate date, String time, String useVas, String useLDTrain, String useRegTrain, String useBus, String useBoat, String useTram, String excludeDR, Integer timeSpan, Integer maxDeparturesPerLine, String needJourneyDetail, Long direction, String format, String jsonpCallback, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {

        // verify the required parameter 'id' is set
        if (id == null) {
            throw new ApiException("Missing the required parameter 'id' when calling getDepartureBoard(Async)");
        }

        // verify the required parameter 'date' is set
        if (date == null) {
            throw new ApiException("Missing the required parameter 'date' when calling getDepartureBoard(Async)");
        }

        // verify the required parameter 'time' is set
        if (time == null) {
            throw new ApiException("Missing the required parameter 'time' when calling getDepartureBoard(Async)");
        }


        com.squareup.okhttp.Call call = getDepartureBoardCall(id, date, time, useVas, useLDTrain, useRegTrain, useBus, useBoat, useTram, excludeDR, timeSpan, maxDeparturesPerLine, needJourneyDetail, direction, format, jsonpCallback, progressListener, progressRequestListener);
        return call;
     ...
     */
    public DepartureBoard getDepartureBoard(Long id, LocalDate date, String time, String useVas, String useLDTrain, String useRegTrain, String useBus, String useBoat, String useTram, String excludeDR, Integer timeSpan, Integer maxDeparturesPerLine, String needJourneyDetail, Long direction, String format, String jsonpCallback) throws ApiException {
        ApiResponse<DepartureBoard> resp = getDepartureBoardWithHttpInfo(id, date, time, useVas, useLDTrain, useRegTrain, useBus, useBoat, useTram, excludeDR, timeSpan, maxDeparturesPerLine, needJourneyDetail, direction, format, jsonpCallback);
        return resp.getData();
    }
     ...
     * @param format the required response format (optional)
     * @param jsonpCallback If JSONP response format is needed, you can append an additional parameter to specify the name of a callback function, and the JSON object will be wrapped by a function call with this name. (optional)
     * @return ApiResponse&lt;DepartureBoard&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<DepartureBoard> getDepartureBoardWithHttpInfo(Long id, LocalDate date, String time, String useVas, String useLDTrain, String useRegTrain, String useBus, String useBoat, String useTram, String excludeDR, Integer timeSpan, Integer maxDeparturesPerLine, String needJourneyDetail, Long direction, String format, String jsonpCallback) throws ApiException {
        com.squareup.okhttp.Call call = getDepartureBoardValidateBeforeCall(id, date, time, useVas, useLDTrain, useRegTrain, useBus, useBoat, useTram, excludeDR, timeSpan, maxDeparturesPerLine, needJourneyDetail, direction, format, jsonpCallback, null, null);
        Type localVarReturnType = new TypeToken<DepartureBoard>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }

    /**
     * Return the next 20 departures (or less if not existing) from a given point in time or the next departures in a given timespan. (asynchronously)
     * This method will return the next 20 departures (or less if not existing) from a given point in time or the next departures in a given timespan. The service can only be called for stops/stations by using according ID retrieved by the location method. The parameter is called id. The time and date are defined with the parameters date and time.
     * @param id stop id (required)
     * @param date the date (required)
     * @param time the time in format HH:MM (required)
     ...
     */
    public com.squareup.okhttp.Call getDepartureBoardAsync(Long id, LocalDate date, String time, String useVas, String useLDTrain, String useRegTrain, String useBus, String useBoat, String useTram, String excludeDR, Integer timeSpan, Integer maxDeparturesPerLine, String needJourneyDetail, Long direction, String format, String jsonpCallback, final ApiCallback<DepartureBoard> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = getDepartureBoardValidateBeforeCall(id, date, time, useVas, useLDTrain, useRegTrain, useBus, useBoat, useTram, excludeDR, timeSpan, maxDeparturesPerLine, needJourneyDetail, direction, format, jsonpCallback, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<DepartureBoard>(){}.getType();
